 ...
 * </p>
 * <ul>
 *   <li>{@link com.leonardo.sorting.graph.impl.EdgeImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.leonardo.sorting.graph.impl.EdgeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link com.leonardo.sorting.graph.impl.EdgeImpl#getFrom <em>From</em>}</li>
 *   <li>{@link com.leonardo.sorting.graph.impl.EdgeImpl#getTo <em>To</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EdgeImpl extends EObjectImpl implements Edge {
	...
	public void setValue(int newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphPackage.EDGE__VALUE, oldValue, value));
	}
